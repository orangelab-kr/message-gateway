...
export const RESULT = {
  ...
  /** CUSTOM ERRORS */
  CANNOT_FIND_ACCESS_KEY: $_$(505, 404, 'CANNOT_FIND_ACCESS_KEY'),
  CANNOT_FIND_TEMPLATE: $_$(506, 404, 'CANNOT_FIND_TEMPLATE'),
  FAILED_SEND_MESSAGE: $_$(507, 500, 'FAILED_SEND_MESSAGE'),
};
